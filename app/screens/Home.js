...
class HomeScreen extends Component {
        ...
        GoogleFit.getDailyStepCountSamples(newOptions)
            .then((res) => {
                if (res == '' && res == null) {
                    ...
                    if (res[2].steps[0].value != null) {
                        let New_Steps = res[2].steps[0].value;
                        if (hasLaunched == null || hasLaunched == '') {
                            console.log("res[2].steps[0].value;", res[2].steps[0].value);
    ...
    ActivitySamples() {
        ...
        //                         var startDate = parseInt(item.start);
        //                         var EndDate = parseInt(item.end);
    ...
    earnCoin() {
        ...
        console.log('steps', this.state.stepsCount)
                        ...
                        <View style={ localStyle.innerContainer }>
                            <View style={ [GlobalStyle.card, localStyle.card] }>
                                ...
                                >
                                    ...
                                    <Text style={ { fontSize: Utils.moderateVerticalScale(10), color: "#fff", } }>Distance</Text>
                                </View>
                            </View>
                        </View>
